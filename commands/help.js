...
module.exports = {
  info: {
    ...
    usage: "[command]",
    aliases: ["commands", "help me", "pls help", "h", "H"]
  },
  ...
  run: async function(client, message, args) {
    ...
    let embed = new MessageEmbed()
      ...
      .setFooter(`Use ${client.config.prefix}help [command] MusicBot 24/7 - Bird YT.`,"https://github.com/navaneethkm004/my-images/blob/main/giphy.gif?raw=true")
